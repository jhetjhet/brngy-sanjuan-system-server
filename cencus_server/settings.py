"""
Django settings for cencus_server project.
...
SECRET_KEY = 'django-insecure-7q=*)4=mrg)h=q+lxq$m)qu_j32(xat6gw36po3lv6(hdq&hhg'
...
ROOT_URLCONF = 'cencus_server.urls'
...
WSGI_APPLICATION = 'cencus_server.wsgi.application'
...
# Custom User Model
AUTH_USER_MODEL = 'brngy_user.BrngyUser'
